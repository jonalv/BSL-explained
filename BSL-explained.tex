...
You can also list classes and properties. For that, the following methods
are at your disposal:\index{getClasses}\index{getAnnotationProperties}\index{getPropertyDeclarationAxioms}
